...
class PrimeraRoute extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Primera ejemplo ruta'),
      ),
      body: Center(
        child: Column(
                  ...
                  children: <Widget>[
                    ...
                    IconButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => LisTileExample()),
                        );
                      },
                    ),
                  ]
...
class SegundaRoute extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
      ...
      body: Center(
        child: IconButton(
          ...
          onPressed: () {
            ...
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => PrimeraRoute()),
            );
          },
        )
      ),
      ...
      body: Column(
        ...
        children: <Widget>[
          Hero(
            ...
            child: Material(
              child: ListTile(
                title: const Text('Titulo de la lista'),
